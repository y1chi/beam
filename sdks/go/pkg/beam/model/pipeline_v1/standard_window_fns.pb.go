...
func (GlobalWindowsPayload_Enum) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_standard_window_fns_03156498b6857f58, []int{0, 0}
}
...
func (FixedWindowsPayload_Enum) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_standard_window_fns_03156498b6857f58, []int{1, 0}
}
...
func (SlidingWindowsPayload_Enum) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_standard_window_fns_03156498b6857f58, []int{2, 0}
}
...
func (SessionsPayload_Enum) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_standard_window_fns_03156498b6857f58, []int{3, 0}
}
...
func (*GlobalWindowsPayload) Descriptor() ([]byte, []int) {
	return fileDescriptor_standard_window_fns_03156498b6857f58, []int{0}
}
...
func (*FixedWindowsPayload) Descriptor() ([]byte, []int) {
	return fileDescriptor_standard_window_fns_03156498b6857f58, []int{1}
}
...
func (*SlidingWindowsPayload) Descriptor() ([]byte, []int) {
	return fileDescriptor_standard_window_fns_03156498b6857f58, []int{2}
}
...
func (*SessionsPayload) Descriptor() ([]byte, []int) {
	return fileDescriptor_standard_window_fns_03156498b6857f58, []int{3}
}
...
func init() {
	proto.RegisterFile("standard_window_fns.proto", fileDescriptor_standard_window_fns_03156498b6857f58)
}

var fileDescriptor_standard_window_fns_03156498b6857f58 = []byte{
