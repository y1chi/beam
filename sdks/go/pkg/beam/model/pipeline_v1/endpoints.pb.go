...
func (*ApiServiceDescriptor) Descriptor() ([]byte, []int) {
	return fileDescriptor_endpoints_93586c0a4e42a840, []int{0}
}
...
func (*OAuth2ClientCredentialsGrant) Descriptor() ([]byte, []int) {
	return fileDescriptor_endpoints_93586c0a4e42a840, []int{1}
}
...
func init() { proto.RegisterFile("endpoints.proto", fileDescriptor_endpoints_93586c0a4e42a840) }

var fileDescriptor_endpoints_93586c0a4e42a840 = []byte{
